        ...
        <div class="specialty-card">
          <div class="specialty-content">
            ...
            <p>
              ...
              performed by experienced surgeons in modern operation theaters. Our team ensures fast recovery
              with personalized post-operative care.
            </p>
            <div class="specialty-features">
              <span><i class="bi bi-check-circle-fill"></i>Minimally Invasive & Laparoscopic Surgery</span>
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
        <div class="specialty-card">
          <div class="specialty-content">
            ...
            <h3>Trauma Care</h3>
            <p>
              24/7 trauma and emergency care with rapid response teams, equipped with the latest life-support
              systems and ICU backup. Ensuring immediate and effective treatment for accidents and emergencies.
            </p>
            <div class="specialty-features">
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="400">
        <div class="specialty-card">
          <div class="specialty-content">
            ...
            <h3>Urology</h3>
            <p>
              Advanced treatments for kidney stones, urinary infections, prostate disorders, and other urological conditions.
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="500">
        <div class="specialty-card">
          <div class="specialty-content">
            ...
            <h3>ENT Services</h3>
            <p>
              Diagnosis and treatment of ear, nose, and throat conditions including sinus issues, hearing loss,
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="600">
        <div class="specialty-card">
          <div class="specialty-content">
            ...
            <h3>Physiotherapy</h3>
            <p>
              Personalized physiotherapy and rehabilitation programs designed to improve mobility, strength,
              and recovery after injury or surgery. Our expert physiotherapists ensure full functional recovery.
            </p>
            <div class="specialty-features">
